...
<p>Our Candidate Database doesn't actually hold onto your resume file itself. What we ask you to do is to provide us a weblink (or 'sharelink') to your resume. That implies that you have your resume accessable online, (for example, if it is stored in a cloud or online location).</p>
...
<ul>
	<li id='g'><a href='#google'>Gmail.com & Google Drive</a></li>
	<li id='d'><a href='#dropbox'>Dropbox</a></li>
	<li id='o'><a href='#onedrive'>Hotmail.com, Live.com, or Outlook & OneDrive</a></li>
</ul>
<h3>You should choose the tutorial that corresponds with your email provider.</p>
<p>(If you do not have a Dropbox account, or an email account with any of Gmail, Hotmail, Live, or Outlook, then go ahead an follow the Dropbox tutorial [as you won't have to create another email account]).</h3>
...
<li>Then head back to the 'Edit Your Profile' area on the Candidate Database, and in the text field that says 'Resume Hyperlink', right click on it and press 'Paste'. You should see that big link that you copied appear in that field.</li>
